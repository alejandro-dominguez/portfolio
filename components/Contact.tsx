...
export default function Contact() {
    ...
    return (
    <div className='2xl:overflow-hidden flex flex-col md:flex-row text-center md:text-left relative min-h-screen
        max-w-7xl px-10 justify-evenly mx-auto items-center pt-28 md:pt-24'>
        <h3 className='z-10 absolute top-24 md:top-16 uppercase tracking-widest text-neutral-300 text-2xl
            ml-3 md:ml-0'>
            Contacto
        </h3>
        <div className="z-10 flex flex-col space-y-5 md:space-y-7">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col space-y-3 mx-auto min-w-[18rem]
                ...
                <button type='submit' className='text-base px-4 py-2 md:text-lg rounded-md bg-[#ffe500]
                    md:bg-[#BAA807] font-black md:font-semibold tracking-[10px] uppercase transition-all
        ...
        <div className='z-0 w-[150%] absolute -bottom-8 bg-[#ffe500]/10 h-[100px] md:h-[90px] -skew-y-2'>
        </div>
    </div>
    )
}